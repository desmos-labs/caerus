...
# App information
APP_ACCOUNT=caerus-app
APP_ACCOUNT_ADDRESS=desmos1npauelfxdyqktexm8dpcl6s93cu4fmnv84xmrw
APP_ACCOUNT_MNEMONIC="goose kite term stamp swallow agree fruit culture cart decorate fame start decrease piece random wheel chuckle course oyster enforce jeans attract inquiry beyond"
...
(echo "$APP_ACCOUNT_MNEMONIC"; echo $KEYRING_PASS; echo $KEYRING_PASS) | desmos keys add "$APP_ACCOUNT" --recover --keyring-backend=file
...
echo $KEYRING_PASS | desmos add-genesis-account $APP_ACCOUNT 200000000000000stake --keyring-backend=file
